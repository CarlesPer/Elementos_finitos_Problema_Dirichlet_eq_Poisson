...
#### `int_triangle(h, s)`
Esta es la función que nos hace el cálculo exacto de integrales sobre el triángulo de referencia de Lagrange. Para ello, se puede observar que usamos cálculo simbólico. Esta función es fundamental para calcular los coeficientes de la matriz de rigidez sin errores de aproximación numérica.
